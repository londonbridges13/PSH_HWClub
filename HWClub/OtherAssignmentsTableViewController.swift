//
//  OtherAssignmentsTableViewController.swift
//  Dac
//
...
//                }
            ...
            if segue.identifier == "oclassToAss"{
            ...
            if segue.identifier == "oNewLessonVC"{
                let vc : NewLessonVC = segue.destinationViewController as! NewLessonVC
            ...
            if segue.identifier == "oclassQtoPVA"{
            ...
            if segue.identifier == "oclassToAnswer"{
                // Send AnswerID Over
                // Send QuestionID
